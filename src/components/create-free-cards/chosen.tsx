      ...
      <Box
        ...
        <Box className="col-span-2 md:col-span-1  p-4 text-center flex flex-col gap-4">
          <Box
            ...
            <Box className="text-left">
              ...
              <Text fontSize="14px" lineHeight="1.6" fontFamily={'Questrial, sans-serif'} color={"rgb(0, 0, 0)"}>
          ...
          <Box
            ...
            <Box className="text-left">
              ...
              <Text fontSize={"sm"} fontFamily={'Questrial, sans-serif'} color={"rgb(0, 0, 0)"}>
          ...
          <Box
            ...
            <Image src="/heart.png" className="w-[85px] h-[85px]" />
            <Box className="text-left">
              <Text fontWeight={"bold"}>Rất nhiều tính năng được sử dụng</Text>
              <Text fontSize={"sm"} fontFamily={'Questrial, sans-serif'} color={"rgb(0, 0, 0)"}>
        ...
        <Box className="col-span-2 md:col-span-1  p-4 text-center flex flex-col gap-4">
          ...
          <Box
            ...
            <Image src="/heart.png" className="w-[85px] h-[85px]" />
            <Box className="text-left">
              <Text fontWeight={"bold"}>Tiết kiệm chi phí và thời gian</Text>
              <Text fontSize={"sm"} fontFamily={'Questrial, sans-serif'} color={"rgb(0, 0, 0)"}>
