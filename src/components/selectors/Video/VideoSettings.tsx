...
import { FaLock, FaUnlock, FaPlay, FaPause, FaVideo } from 'react-icons/fa';
        ...
        <Tabs.Content value="default">
          <Stack >
            ...
            <Box borderBottom="1px solid #e0e0e0" borderRadius={4} p={4}>
              <Stack gap={3}>
                <Box>
                  <Text fontSize="sm" fontWeight={'bold'} mb={2}>URL Video</Text>
                  <Input
                    value={props.videoUrl || ''}
                    onChange={(e) => updateProp('videoUrl', e.target.value)}
                    placeholder="Nhập URL video (YouTube, MP4, etc.)"
                    size="sm"
                  />
                </Box>
                {props.videoType == 'meHappyVideo' ?
                  <Button
                    size="sm"
                    onClick={() => showFileSelectModal(
                      FileType.VIDEO,
                      (fileUrl: string) => {
                        updateProp('videoUrl', fileUrl);
                      }
                    )}
                  >
                    Chọn
                ...
                <Box className='w-full flex items-center justify-between'>
                  ...
                  <select
                    ...
                    onChange={(e: React.ChangeEvent<HTMLSelectElement>) => {
                      updateProp('videoType', e.target.value);
                      updateProp('videoUrl', '');
                    }}
                  >
                ...
                <Stack gap={3}>
                  <HStack justifyContent="space-between" alignItems="center">
                    ...
                    <Text fontSize="xs">Tự động phát</Text>
                    <Switch.Root
                      checked={props.autoPlay || false}
                      onCheckedChange={(e) => updateProp('autoPlay', e.checked)}
                    >
                      <Switch.HiddenInput />
                      <Switch.Control>
                        <Switch.Thumb />
                  ...
                  <HStack justifyContent="space-between" alignItems="center">
                    <Text fontSize="xs">Hiển thị điều khiển</Text>
                    <Switch.Root
                      checked={props.showControls || false}
                      onCheckedChange={(e) => updateProp('showControls', e.checked)}
                    >
                      <Switch.HiddenInput />
                      <Switch.Control>
                        <Switch.Thumb />
