...
export const DropboxSettings = () => {
  const {
    ...
    props: node.data.props as DropboxProps
  }));
  ...
  const updateProp = (key: keyof DropboxProps, value: any) => {
    setProp((props: any) => {
      props[key] = value;
    });
  };
  ...
  return (
    <Box className='w-full h-full'>
      <Tabs.Root key={'dropboxsetting'} value={settingType} onValueChange={(e) => setSettingType(e.value)} variant={'line'}>
        <Tabs.List>
